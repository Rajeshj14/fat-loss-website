...
//         <div className="absolute inset-0 mt-25 max-sm:mt-20">
//           <img
//             src="/ban-image.jpg"
...
//               {/* Badge */}
//               <div
//                 className="inline-flex items-center gap-2 px-4 py-2 mb-2 rounded-full backdrop-blur-md animate-shimmer-border"
//                 style={{
//                   background:
...
//               {/* Sub-headline */}
//               <p
//                 className="text-base sm:text-lg lg:text-xl leading-relaxed max-w-2xl drop-shadow-md mb-1"
//                 style={{ color: "#dcdcdc" }}
//               >
...
//                   }
//                   className="group relative w-full sm:w-auto px-6 lg:px-8 py-4 lg:py-5 text-gray-900 text-base lg:text-lg font-bold rounded-2xl overflow-hidden transition-all duration-300 hover:scale-105 animate-pulse-glow"
//                   style={{
...
//                   className="group w-full sm:w-auto px-6 lg:px-8 py-4 lg:py-5 backdrop-blur-md text-base lg:text-lg font-bold rounded-2xl transition-all duration-300 shadow-lg flex items-center justify-center gap-2 hover:scale-105"
//                   style={{
...
//       {/* Stats Section */}
//       <section className="relative max-sm:py-6 py-10 lg:pb-5 lg:pt-5 bg-gray-900 overflow-hidden">
//         {/* Background Pattern */}
