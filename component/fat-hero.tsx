...
//           {/* Hero Section */}
//           <div className="flex flex-col lg:flex-row items-stretch gap-6 sm:gap-8 md:gap-10 lg:gap-12 xl:gap-16">
...
//                   <span className="font-semibold text-xs sm:text-sm md:text-base lg:text-lg text-white">
...
//                   <h1 className="text-3xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl font-extrabold text-gray-900 leading-tight">
//                     Get the Body You{" "}
...
//                     }
//                     className="group flex-1 px-4 py-3 sm:px-5 sm:py-4 md:px-6 md:py-4 text-white text-sm sm:text-base md:text-lg font-bold rounded-xl transition-all hover:scale-[1.02] hover:shadow-lg"
//                     style={{
//                       background: "linear-gradient(135deg, #ba736b, #a8645d)",
//                     }}
//                   >
...
//                     className="flex-1 px-4 py-3 sm:px-5 sm:py-4 md:px-6 md:py-4 bg-white text-sm sm:text-base md:text-lg font-bold border border-gray-200 rounded-xl transition-all hover:scale-[1.02] hover:shadow-lg flex items-center justify-center gap-2 sm:gap-3 hover:border-[#ba736b]/30"
//                     style={{
//                       color: "#ba736b",
//                     }}
//                   >
...
//                 <div className="relative w-full h-full min-h-[300px] sm:min-h-[350px] md:min-h-[400px] lg:min-h-[450px] xl:min-h-[500px] rounded-xl sm:rounded-2xl overflow-hidden bg-gray-100 shadow-xl sm:shadow-2xl">

//                   {/* Video Loading Overlay */}
//                   {!isVideoLoaded && (
//                     <div className="absolute inset-0 flex items-center justify-center bg-gray-900/90 rounded-xl sm:rounded-2xl z-10">
//                       <div className="text-center">
//                         <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 border-4 border-[#ba736b] border-t-transparent rounded-full animate-spin mx-auto mb-2 sm:mb-3"></div>
...
//                   {/* Video Controls Bar */}
//                   <div className="absolute top-2 right-2 sm:top-3 sm:right-3 md:top-4 md:right-4 flex gap-1 sm:gap-1.5 md:gap-2 z-20">
//                     <button
//                       onClick={toggleMute}
//                       className="bg-black/60 hover:bg-black/80 p-1 sm:p-1.5 md:p-2 rounded-lg transition-all backdrop-blur-sm"
//                       aria-label={isMuted ? "Unmute video" : "Mute video"}
//                     >
//                       {isMuted ? (
//                         <svg className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 text-[#ba736b]" fill="currentColor" viewBox="0 0 24 24">
...
//                     <button
//                       onClick={changeSpeed}
//                       className="bg-black/60 hover:bg-black/80 px-2 py-1 sm:px-2.5 sm:py-1.5 md:px-3 md:py-2 rounded-lg transition-all backdrop-blur-sm text-[#ba736b] text-xs sm:text-sm font-bold"
...
//                     {!isPlaying && (
//                       <button onClick={toggleVideo} className="group" aria-label="Play video">
//                         <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 lg:w-20 lg:h-20 bg-gradient-to-br from-[#ba736b] to-[#a8645d] rounded-full flex items-center justify-center shadow-lg transition-all duration-300 group-hover:scale-110 group-hover:shadow-xl">
//                           <svg className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 lg:w-10 lg:h-10 text-white ml-0.5" fill="currentColor" viewBox="0 0 24 24">
...
//                     {isPlaying && (
//                       <button onClick={toggleVideo} className="absolute inset-0 w-full h-full opacity-0 hover:opacity-100 transition-opacity duration-300 bg-black/20" aria-label="Pause video">
//                         <div className="absolute inset-0 flex items-center justify-center">
//                           <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 lg:w-20 lg:h-20 bg-gradient-to-br from-[#ba736b]/80 to-[#a8645d]/80 rounded-full flex items-center justify-center shadow-lg backdrop-blur-sm">
//                             <div className="flex items-center justify-center space-x-1 sm:space-x-1.5">
//                               <div className="w-1 h-5 sm:w-1.5 sm:h-6 md:w-2 md:h-7 bg-white rounded-sm"></div>
//                               <div className="w-1 h-5 sm:w-1.5 sm:h-6 md:w-2 md:h-7 bg-white rounded-sm"></div>
//                             </div>
//                           </div>
//                         </div>
...
//                   {/* Progress Bar */}
//                   {isPlaying && (
//                     <div className="absolute bottom-0 left-0 right-0 h-0.5 sm:h-1 z-10">
//                       <div className="h-full bg-gradient-to-r from-[#ba736b] via-[#d4a5a0] to-[#ba736b] animate-pulse" style={{ width: "100%", transition: "width 0.3s ease" }}></div>
//                     </div>
//                   )}
//                 </div>
//               </div>
          ...
          <div className="flex flex-col lg:flex-row items-stretch gap-6 sm:gap-8 md:gap-10 lg:gap-12 max-sm:pt-15 pt-20 xl:gap-16">
            ...
            <div className="w-full lg:w-1/2 flex items-center">
              <div className="w-full space-y-2 sm:space-y-5 md:space-y-6 lg:space-y-8">
                ...
                {/* CTAs */}
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-5 pt-0 sm:pt-6">
                  <button
                    onClick={() =>
                      document
                        .querySelector("#contact")
                    ...
                    className="group px-4 py-3 sm:px-8 sm:py-4 md:px-10 md:py-4 text-white text-sm sm:text-base md:text-lg font-bold rounded-xl transition-all hover:scale-[1.02] hover:shadow-lg whitespace-nowrap"
                    style={{
                      background: "linear-gradient(135deg, #ba736b, #a8645d)",
                    }}
                  >
                  ...
                  <a
                    href="tel:+918826815442"
                    className="px-4 py-3 sm:px-8 sm:py-4 md:px-10 md:py-4 bg-white text-sm sm:text-base md:text-lg font-bold border border-gray-200 rounded-xl transition-all hover:scale-[1.02] hover:shadow-lg flex items-center justify-center gap-2 sm:gap-3 hover:border-[#ba736b]/30 whitespace-nowrap"
                    style={{
                      color: "#ba736b",
                    }}
                  >
