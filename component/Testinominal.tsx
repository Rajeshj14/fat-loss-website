...
export default function FAQ() {
  ...
  const faqs = [
    {
      question: "How is medical weight loss different from a regular gym or diet plan?",
      answer: "At Swakaaya, we address the biological factors behind weight gain. While gyms focus on effort, we focus on metabolic health, hormonal balance, and using FDA-approved technology to target fat cells that are resistant to exercise."
    },
    {
      question: "Are the weight loss treatments at Swakaaya safe?",
      answer: "Yes. All our procedures are non-surgical and non-invasive. We use medically cleared technologies and evidence-based protocols performed under the supervision of experienced clinical experts to ensure total safety."
    },
    {
      question: "Which treatment is right for me?",
      answer: "Weight loss is personal. During your initial consultation, we perform a detailed body composition analysis to determine whether you need targeted fat reduction (like Cryolipolysis), skin tightening, or a metabolic lifestyle plan."
    },
    {
      question: "How much weight can I expect to lose?",
      answer: "Results vary based on your starting point and metabolism. However, most patients see a visible reduction in inches and a significant drop in body fat percentage within the first few sessions. We focus on \"fat loss\" rather than just \"water weight.\""
    },
    {
      question: "Is there any downtime after the procedures?",
      answer: "Not at all. Our treatments are \"lunch-break\" procedures. You can walk into our Gurgaon clinic for your session and immediately return to your work or daily routine without any recovery time."
    },
    {
      question: "Will I regain the weight after the treatment ends?",
      answer: "Our treatments permanently destroy targeted fat cells. However, maintaining your new shape requires a balanced lifestyle. We provide you with the nutritional guidance needed to ensure your results stay permanent."
    },
    {
      question: "Does the treatment hurt?",
      answer: "Most clients describe the sensation as a mild cooling or warming feeling, depending on the technology used. It is generally a comfortable experience, and many of our clients relax or listen to music during the session."
    },
    {
      question: "How many sessions will I need?",
      answer: "While some clients notice a difference after 2 sessions, a typical transformative course consists of 6 to 8 sessions. We will give you a clear timeline during your first assessment."
    },
    {
      question: "How do I get started?",
      answer: "The first step is a professional consultation. You can call us at +91 8826815442 or click the \"Book Consultation\" button to schedule your body assessment at our Gurgaon clinic."
    }
  ];
            ...
            >
              ...
              >
                <div className="flex items-start gap-3 flex-1">
                  <span className="font-bold text-lg" style={{ color: '#d4ad5f' }}>
                    {index + 1}.
                  </span>
                ...
                <div
                  ...
                  style={{
                    backgroundColor: openIndex === index ? '#d4ad5f' : 'transparent',
