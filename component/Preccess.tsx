  ...
  const features = [
    {
      ...
      description: "Personalized treatment plans tailored to your unique body composition and health goals",
      icon: (
    ...
    },
    {
      ...
      description: "FDA-approved, medically cleared equipment for safe and effective fat reduction",
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: "Zero Downtime",
      description: "Walk-in, walk-out procedures that fit seamlessly into your busy lifestyle",
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Comprehensive guidance including nutrition, lifestyle, and ongoing medical supervision",
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <div className="min-h-screen py-20 px-4 bg-gradient-to-br from-gray-50 via-white to-gray-100">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="absolute top-20 right-10 w-64 h-64 rounded-full opacity-5 -z-10" style={{ backgroundColor: '#d4ad5f' }}></div>
        <div className="absolute bottom-20 left-10 w-48 h-48 rounded-full opacity-5 -z-10" style={{ backgroundColor: '#dcdcdc' }}></div>
      </div>
    </div>
  );
}